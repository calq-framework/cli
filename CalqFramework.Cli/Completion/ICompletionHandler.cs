...
public interface ICompletionHandler {
    ...
    /// </summary>
    void HandleComplete(ICliContext context, IEnumerable<string> args, object target);
    ...
    /// </summary>
    void HandleCompletion(ICliContext context, IEnumerable<string> args, object target);
}

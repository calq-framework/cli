...
public class CliException : Exception {
    ...
    public CliException(string option, string message, Exception innerException) : base($"option '{option}': {message}", innerException) { }
    ...
    /// <param name="message">The error message</param>
    /// <param name="innerException">The inner exception</param>
    public CliException(string option, string value, string message, Exception innerException) : base($"option '{option}={value}': {message}", innerException) { }
}
